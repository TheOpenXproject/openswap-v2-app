<template>
  <div class="flex flex-wrap w-full">
    ...
    <div v-if="validator" class="flex plex-1 gap-3 min-w-0 w-full text-gray-600 dark:text-gray-300">
      <div class="flex flex-col w-full st5 rounded-2xl bg-gradient-to-l dark:from-slightDark from-slightGray to-transparent dark:hover:bg-slightDark hover:bg-slightGray py-3 px-4">
