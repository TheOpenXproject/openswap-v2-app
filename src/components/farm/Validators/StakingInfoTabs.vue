          ...
          <div class="tab-content tab-space">
            ...
            <div v-bind:class="{ 'hidden h-full': openTab !== 3, 'h-full flex flex-wrap justify-between': openTab === 3 }">
             <h5 class="w-full">Set Reward Ratio Openx:One</h5>
              ...
              <button @click="setRatioVal()" class="flex w-full lg:w-2/12 mt-2 items-center justify-center rounded-xl border border-oswapGreen st5 text-oswapGreen hover:bg-oswapGreen hover:text-gray-200 dark:hover:text-slightDark">
