<template>
  <div class="flex flex-wrap w-full">
    <div class="flex space-x-2 w-full items-center mb-6">
    ...
    <transition name="fall" appear>
      <div class="flex flex-wrap w-full">
        <div v-if="validators" v-for="validator in validators" :key="validator" class="ss:w-full lg:w-6/12">
        ...
        <div v-if="validators" v-for="validator in validators" :key="validator" class="w-full">
