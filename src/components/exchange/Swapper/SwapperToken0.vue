  ...
  <div class="flex flex-1 items-center">
    ...
    <div class="flex flex-col space-y-1 w-1/3 min-w-0">
      ...
      <div class="relative flex space-x-2 items-center h-10">
        <i @click="addTokenToMetamask(this.getToken()['token1'])" class="flex las la-plus text-sm p-1 text-oswapGreen absolute top-0 left-0 items-center justify-center bg-slightGray dark:bg-slightDark rounded-full cursor-pointer shadow hover:bg-oswapGreen dark:hover:bg-oswapGreen hover:text-slightGray dark:hover:text-slightDark"></i>
    ...
    <div class="flex flex-col space-y-1 flex-1 w-2/3 min-w-0">
      <div class="flex h-10">
        <Input0 :errors="errors" :rounded="'rounded-xl'" @input0="input0" :placeholder="'Amount...'" :errorTop="'pt-10'">
